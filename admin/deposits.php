      ...
      <div class="container-fluid">
        <div class="page-titles">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">All Ultimate Trust Trade Deposits</a></li>
          </ol>
        </div>
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">All Ultimate Trust Trade Deposits</h4>
            </div>
            <div class="card-body">
                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="edit_deposit.php?pid=<?php echo $data->deposit_id; ?>">Edit</a>
                                  <a class="dropdown-item" href="delete_deposit.php?pid=<?php echo $data->deposit_id; ?>">Delete</a>
                                </div>
                              </div>
                            </td>
                          </tr>
