      ...
      <div class="container-fluid">
        <div class="page-titles">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">All Ultimate Trust Trade Investments</a></li>
          </ol>
        </div>
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">All Ultimate Trust Trade Investments</h4>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    ...
                    ?>
                          <tr>
                            ...
                            <td><?php echo round($data->mature); ?> Days</td>
                            <td><?php
                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="edit_investment.php?pid=<?php echo $data->invest_id; ?>">Edit</a>
                                  <a class="dropdown-item" href="delete_investment.php?pid=<?php echo $data->invest_id; ?>">Delete</a>
                                </div>
                              </div>
                            </td>
                          </tr>
