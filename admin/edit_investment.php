...
<body>
  ...
  <div id="main-wrapper">
    ...
    if (isset($_POST['update'])) {
      ...
      if (!empty($status)) {
        $call = setSingleInvestment($status);
      }
    }
    ?>
      ...
      <div class="container-fluid">
        <div class="page-titles">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="investments.php">All Ultimate Trust Trade Investments</a></li>
            <li class="breadcrumb-item active"><a href="#">Single Ultimate Trust Trade Investment</a></li>
                          ...
                          <div id="profile-settings" class="tab-pane">
                            <div class="pt-3">
                              <div class="settings-form">
                                <h4 class="text-primary">Approve User Investment</h4>
                                <form method="post">
                                  <div class="form-row">
                                    <div class="form-group col-md-12 mt-5">
                                      <label>Current Investment Status</label>
