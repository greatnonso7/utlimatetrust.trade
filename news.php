...
<body>
    <div id="main-header">
        ...
        <div id="sub-header">
            <div class="ls-left">
                <div class="lslogin">
                    <a href="?a=login" class="a-link"><i class="fa fa-key" aria-hidden="true"></i> Log In</a>
                </div>
                <div class="lssignup">
                    <a href="?a=signup" class="a-link"><i class="fa fa-user-plus" aria-hidden="true"></i> Sign Up</a>
                </div>
            </div>
            <div class="addby">
                <div class="phone">
    ...
    <div id="main-reg">
        <div style="padding-bottom:30px;" id="sub-contact">
            <!--id change-->
